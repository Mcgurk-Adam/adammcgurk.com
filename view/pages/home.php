<main>
    ...
    <section class="home-sections">
        ...
        <div id="pro-experience-container">
            <div class="experience-card animated-away">
    ...
    <section class="home-sections white">
        ...
        <div id="project-container">
            <div class="project-card animated-away">

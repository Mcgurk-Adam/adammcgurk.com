...
<!-- 				<div class="tile" data-tech-tags="netlify gcp html-css ts design php twilio pwa sendgrid sql">
	...
	<section id="about">
		...
		<div class="content">
			...
			<p class="explainer left">Third, building the company's software suite. Luminary, the name of our custom software suite, is the sales, marketing, and fulfillment platform for Shine Solar. It was also something that I built in three months! It's since grown haha. <a href="https://dev.to/mcgurkadam/lessons-learned-from-building-my-company-s-sales-and-marketing-platform-in-three-months-pm4" title="View Luminary" target="_blank" rel="noopener">Click this link to read more about that!</a> Luminary is my proudest professional accomplishment. Having processed over 500,000 calls, 100,000 texts, and $60,000,000 in revenue, it is the brains and mechanism behind everything we do at Shine Solar. It informs executives with reports, holds all the data for our customers for our sales and customer support, and enables all communication between customers and Shine Solar.</p>
